...
{
    public partial class SuaCSDien : Form
    {
        private string IdCs;
        private Loader Loader;
        public SuaCSDien(string idCs , Loader loader)
        {
            InitializeComponent();
            this.IdCs = idCs;
            this.Loader = loader;
        ...
        private Boolean checkHopLe()
        {
            ...
            if (txtCsCu.Text != "")
            {
                ...
                {
                    i++;
                    errorProvider1.SetError(txtCsCu  , "Chi so dien phải bằng số");
            ...
            if (txtCsMoi.Text != "")
            {
                ...
                {
                    i++;
                    errorProvider1.SetError(txtCsMoi, "Chi so nuoc phải bằng số");
